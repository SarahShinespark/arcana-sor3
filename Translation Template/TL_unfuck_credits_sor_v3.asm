...
;NOTE to translators
;-------------------;
;The credits text is tile data (graphics) and not plain text.
;Existing letters could be rearranged, but Latin characters will need to be drawn.
;Each letter uses 5 bytes:
;  db $00       ; 0 = continue reading after this letter, 2 = stop
;  db $43       ; X pos 43 (center right)
;  db $01       ; Y pos 1
;  db $82       ; 82 = "S"  <------The 4th byte determines which letter is written
;  db $3C       ; 3C = Orange text

;Existing letters and their bytes
;(A0-AA and C0-CA are used for The End)
;A 00    I 20    Q 40     Y 60   ER 80   - A0  - C0
;B 02    J 22    R 42     Z 62    S 82   - A2  - C2
;C 04    K 24    S 44  KOBY 64   TO 84   - A4  - C4
;D 06    L 26    T 46  KOBY 66    R 86   - A6  - C6
;E 08    M 28    U 48  KOBY 68      88   - A8  - C8
;F 0A    N 2A    V 4A    @" 6A      8A   - AA  - CA
;G 0C    O 2C    W 4C       6C      8C     AC    CC
;H 0E    P 2E    X 4E       6E      8E     AE    CE
