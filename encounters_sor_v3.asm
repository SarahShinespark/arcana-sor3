...
org $18910B
Ch_Boss_Position:   ;Pointer table to boss data (8 bytes per entry), see 1880F8
...
Tbl_Ch_Encounter_Sets: 
 dw Encounters_Ch1_tile10             ;18913D|189147;
...
Encounters_Ch1_tile10:
 db $05                 ;189147; Tile 10 (5 entries)
...
Encounters_Ch1_tile11:
 db $05                 ;18914E; Tile 11 (5 entries)
...
Encounters_Ch1_tile12:
 db $05                 ;189155; Tile 12 (5 entries)
...
Encounters_Ch1_tile13:
 db $05                 ;18915C; Tile 13 (5 entries)
...
Encounters_Ch1_tile14:
 db $05                 ;189163; Tile 14 (5 entries)
...
Encounters_Ch1_tile15:
 db $05                 ;18916A; Tile 15 (5 entries)
...
Encounters_Ch1_tile16:
 db $11                 ;189171; Tile 16 (1 entry)
 db $01                 ;189172; Zone 01 (boss)
 db !StoneGolem         ;189173;

Encounters_Ch1_tile17:
 db $11                 ;189174; Tile 17 (1 entry)
 db $01                 ;189175; Zone 01 (boss)
 db !IronGolem          ;189176;

Encounters_Ch2_tile10:
 db $05                 ;189177;  
...
Encounters_Ch2_tile16:
 db $11                 ;1891A1;  
 db $01                 ;1891A2; Zone 01
 db !Cyclops            ;1891A3;

Encounters_Ch2_tile17:
 db $11                 ;1891A4;  
 db $04                 ;1891A5; Zone 04 
 db !Ifrit              ;1891A6;

Encounters_Ch2_tile18:
 db $11                 ;1891A7;  
 db $05                 ;1891A8; Zone 05
 db !Zero               ;1891A9; 

Encounters_Ch3_tile10:
 db $05                 ;1891AA;  
 db $03                 ;1891AB;  
 db !Gel                ;1891AC;  
 db !Hobgoblin          ;1891AD;  
...
Encounters_Ch3_tile16:
 db $01                 ;1891D4;  
 db $04                 ;1891D5;  
 db !Mimic              ;1891D6; Mimic!

Encounters_Ch3_tile17:
 db $11                 ;1891D7;  
 db $07                 ;1891D8;  
 db !Sauza              ;1891D9;  

Encounters_Ch3_tile18:
 db $11                 ;1891DA;  
 db $01                 ;1891DB;  
 db !Hydra              ;1891DC;  

Encounters_Ch4_tile10:
 db $05                 ;1891DD;  
 db $03                 ;1891DE;  
 db !Ghoul              ;1891DF;  
 db !Bugbear            ;1891E0;  
...
Encounters_Ch4_tile19:
 db $11                 ;18921C;  
 db $01                 ;18921D;  
 db !Darah              ;18921E;  

Encounters_Ch4_tile1A:
 db $02                 ;18921F;  
 db $08                 ;189220;  
 db !Darah              ;189221;  
 db !Barah              ;189222;  

Encounters_Ch4_tile1B:
 db $01                 ;189223;  
 db $01                 ;189224;  
 db !Alan               ;189225;  

Encounters_Ch4_tile1C:
 db $01                 ;189226;  
 db $01                 ;189227;  
 db !Teefa              ;189228;  

Encounters_Ch5_tile10:
 db $05                 ;189229;  
 db $06                 ;18922A;  
 db !SeaDgn             ;18922B;  
 db !SeaDgn             ;18922C;  
...
Encounters_Ch5_tile18:
 db $11                 ;189261;  
 db $01                 ;189262;  
 db !Karla              ;189263;  

Encounters_Ch5_tile19:
 db $01                 ;189264;  
 db $01                 ;189265;  
 db !Galneon1           ;189266;  

Encounters_Ch5_tile1A:
 db $11                 ;189267;  
 db $01                 ;189268;  
 db !Galneon2           ;189269;  

Encounters_Ch5_tile1B:
 db $21                 ;18926A;  
 db $09                 ;18926B;  
 db !Rimsala1           ;18926C;  

Encounters_Ch5_tile1C:
 db $31                 ;18926D;  
 db $09                 ;18926E;  
 db !Rimsala2           ;18926F;  
...
org $189270
Tbl_Zone_Formations: 
 dw Formation_Zone_00_Num_Entries     ;189270|189288;
...
;***3.0: Encounter odds 5, 8, 11, 5, 7 /16
org $18937C
...
;***3.0: Encounter odds 16, _, 3, 4, 4 /16
org $189407
