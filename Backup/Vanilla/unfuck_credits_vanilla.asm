;Unfuck credits (vanilla version)
;1. Makes the credits easier to read and modify.
;2. Adds a missing credit "Message Coordinator Abeshi"
;3. Fixes spelling ("Programer" -> "Programmer" and "Adviser" -> "Advisor")
;4. Overwrites some unused duplicate entries for the space needed.
...
;Every new line, sets how far apart the credits are from each other
  LDX.W Credits_Progress               ;01BC0A|AE2719  |001927;  
  LDA.L Credits_Distance,X             ;01BC0D|BF1BBC01|01BC1B;  
  AND.W #$00FF                         ;01BC11|29FF00  |      ;  
  LDY.W Results                        ;01BC14|AC4110  |001041;  
...
; Draws ~The End~ if all credits have been drawn
  LDA.W Credits_Progress               ;01BC49|AD2719  |001927;
  SEC                                  ;01BC4C|38      |      ;  
  SBC.W #!Num_Credits                  ;01BC4D|E92E00  |      ;  
  RTL                                  ;01BC50|6B      |      ;  

org $01BC65
;Update pointer to Anim IDs
  LDA.L Credits_Anim_IDs,X             ;01BC65|BF85BC01|01BC85;  
...
; RAM $1927 = $01 to $30 (Tracks which line it's printing)
  db !Section                ;01BC1B|        |      ;  Executive Producer
  db !End_Block              ;01BC1C|        |      ;  
  db !Section                ;01BC1D|        |      ;  Producer
  db !End_Block              ;01BC1E|        |      ;  
  db !Section                ;01BC1F|        |      ;  Directors
  db !Section                ;01BC20|        |      ;  
  db !End_Block              ;01BC21|        |      ;  
  db !Section                ;01BC22|        |      ;  Script Writers
  db !Section                ;01BC23|        |      ;  
  db !End_Block              ;01BC24|        |      ;  
  db !Section                ;01BC25|        |      ;  Main Programer
  db !End_Block              ;01BC26|        |      ;  
  db !Section                ;01BC27|        |      ;  Programers
  db !Section                ;01BC28|        |      ;  
  db !Section                ;01BC29|        |      ;  
  db !Section                ;01BC2A|        |      ;  
  db !End_Block              ;01BC2B|        |      ;  
  db !Section                ;01BC2C|        |      ;  Character Designers
  db !Section                ;01BC2D|        |      ;  
  db !Section                ;01BC2E|        |      ;  
  db !Section                ;01BC2F|        |      ;  
  db !Section                ;01BC30|        |      ;  
  db !Section                ;01BC31|        |      ;  
  db !End_Block              ;01BC32|        |      ;  
  db !Section                ;01BC33|        |      ;  Music Director
  db !End_Block              ;01BC34|        |      ;  
  db !Section                ;01BC35|        |      ;  Music Composers
  db !Section                ;01BC36|        |      ;  
  db !End_Block              ;01BC37|        |      ;  
  db !Section                ;01BC38|        |      ;  Message Programers
  db !Section                ;01BC39|        |      ;  
  db !End_Block              ;01BC3A|        |      ;  
  db !Section                                       ;  Message Coordinator
  db !End_Block
  db !Section                ;01BC3B|        |      ;  Debug Director
  db !End_Block              ;01BC3C|        |      ;  
  db !Section                ;01BC3D|        |      ;  Technical Adviser
  db !End_Block              ;01BC3E|        |      ;  
  db !Section                ;01BC3F|        |      ;  Main Advertiser
  db !End_Block              ;01BC40|        |      ;  
  db !Section                ;01BC41|        |      ;  Special Thanks To
  db !Section                ;01BC42|        |      ;  
  db !Section                ;01BC43|        |      ;  
  db !Section                ;01BC44|        |      ;  
  db !Section                ;01BC45|        |      ;  
...
Credits_Text_3A:  ; Message Coordinator
db $00, $B3, $01, $28, $3C  ;M
db $00, $BE, $01, $08, $3C  ;E
db $00, $C6, $01, $44, $3C  ;S
db $00, $CE, $01, $44, $3C  ;S
