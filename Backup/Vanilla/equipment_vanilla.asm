;Holds equipment stats (weapons, armor, amulets, rings)
...
org $05D67D : EquipNames:     ;Equipment names (16b + /00)
org $05DE86 : EquipPrices:    ;Equipment prices (2b)
org $05DF78 : EquipFlags:     ;Equip flags (1b): xxxADSTR  (Binary xxx00001 = Rooks only, xxxx01000 = Salah only etc)
org $05DFF1 : EquipPower:     ;Equip power/defense (2b)
org $05E0E3 : EquipAffinity:  ;Equip race/element (2b): (Binary FAEWxxxx xxxxGMDU, Element FAEW Fire/Water/Earth/Wind, Race GMDU Giant/Medusa/Dragon/Undead)
org $05E1D5 : EquipSpecial:   ;Equip special (1b) (crit%/magic defense)
org $05E24E : EquipPenalty:   ;Equip penalty (1b) (higher = reduced attack)
org $05E2C7 : EquipSpellcast: ;Equip spellcast (1b)
...
%equipment(0, 0, 0, 0, 0, 0, 52, 205, 0)                        ;unarmed
...
%equipment(24, 700, !Salah, 60, 0, 0, 10, 108, 0)               ;Memory Wand
%equipment(25, 1000, !Salah, 100, 0, !AFire, 10, 72, !Flame1)   ;Firebrand
%equipment(26, 4500, %00110, 110, 0, 0, 10, 67, !SleepA)        ;Elder's Staff
%equipment(27, 10000, !Salah, 120, 0, 0, 10, 62, !Water2)       ;Wish Wand
...
%equipment(36, 5500, %00110, 60, 0, 0, 10, 77, 0)               ;Blackthorne Whip
...
%equipment(62, 1000, !Salah, 145, 0, 0, 0, 0, 0)                ;White Robe
%equipment(63, 20, !Salah, 160, 0, 0, 0, 0, 0)                  ;Shaman Robe
...
%equipment(88, 4000, !Salah, 160, 0, 0, 35, 0, !Sleep)          ;Magic Shield
...
;org $05E340 : SpellNames:     ;Spell names
